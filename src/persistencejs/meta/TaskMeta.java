...
//@javax.annotation.Generated(value = { "slim3-gen", "@VERSION@" }, date = "2010-10-04 04:55:47")
/** */
public final class TaskMeta extends org.slim3.datastore.ModelMeta<persistencejs.model.Task> {
    ...
    public void syncDone(persistencejs.model.Task task, boolean done) {
        if (task.isDone() != done) {
            task.setDirty(true);
        }
    }

    public void syncName(persistencejs.model.Task task, java.lang.String name) {
